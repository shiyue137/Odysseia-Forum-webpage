    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col gap-0 p-4 sm:p-6 lg:p-8">
      ...
      <section className="relative flex flex-col items-center justify-center py-8 sm:py-10 lg:py-12">
        ...
        <DrawSettingsPanel
          ...
          onRestorePreferences={restorePreferenceRecipe}
          onScopeModeChange={(mode) => setRecipe((current) => ({ ...current, scopeMode: mode }))}
          onTagLogicChange={(logic) => setRecipe((current) => ({ ...current, tagLogic: logic }))}
          onToggleChannel={toggleRecipeChannel}
          onToggleTag={toggleRecipeTag}
          onRevealEnabledChange={setRevealEnabled}
        />
      </section>
